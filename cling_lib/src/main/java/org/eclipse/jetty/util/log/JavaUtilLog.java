 ...
 * standard java.org.eclipse.jetty.org.eclipse.jetty.util.logging configuration</a>.
 * </p>
 */
public class JavaUtilLog extends AbstractLogger
{
    ...
    public JavaUtilLog()
    {
        this("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log");
    }

    public JavaUtilLog(String name)
    {
        _logger = java.util.logging.Logger.getLogger(name);
        if (Boolean.parseBoolean(Log.__props.getProperty("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.DEBUG", "false")))
        {
