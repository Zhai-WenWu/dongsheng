 ...
 * <p>
 * If the system property "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.SOURCE" is set, then the source method/file of a log is logged.
 * For named debuggers, the system property name+".SOURCE" is checked, eg "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.stderr.SOURCE".
 * If it is not not set, then "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.SOURCE" is used as the default.
 * <p>
 * If the system property "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.stderr.LONG" is set, then the full, unabbreviated name of the logger is
 * used for logging.
 */
public class StdErrLog extends AbstractLogger
{
    ...
    private final static boolean __source = Boolean.parseBoolean(Log.__props.getProperty("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.SOURCE",
            Log.__props.getProperty("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.stderr.SOURCE","false")));
    private final static boolean __long = Boolean.parseBoolean(Log.__props.getProperty("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.stderr.LONG","false"));
    ...
    static
    {
        ...
        { "DEBUG", "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.DEBUG", "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.stderr.DEBUG" };
