 ...
 * <p>
 * The "org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.class" system property can be used
 * to select a specific logging implementation.
 * <p>
 * If the system property org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.IGNORED is set,
...
public class Log
{
    ...
    static
    {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
                 ...
                 */
                __logClass = __props.getProperty("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.class","org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.Slf4jLog");
                __ignored = Boolean.parseBoolean(__props.getProperty("org.eclipse.jetty.org.eclipse.jetty.org.eclipse.jetty.util.log.IGNORED","false"));
                return null;
            }
        });
    }
    ...
    public static void setLogToParent(String name)
    {
        ...
        if (loader!=null && loader.getParent()!=null)
        {
            try
            {
                Class<?> uberlog = loader.getParent().loadClass("org.eclipse.jetty.org.eclipse.jetty.util.log.Log");
