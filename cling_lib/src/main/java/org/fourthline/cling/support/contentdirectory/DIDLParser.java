 ...
 * </p>
 * <p>
 * Override the {@link #createDescMetaHandler(org.fourthline.cling.support.model.DescMeta, Handler)}
 * method to read vendor extension content of {@code <desc>} elements. You then should also override the
 * {@link #populateDescMetadata(Element, org.fourthline.cling.support.model.DescMeta)} method for writing.
 * </p>
 * <p>
 * Override the {@link #createItemHandler(org.fourthline.cling.support.model.item.Item, Handler)}
...
public class DIDLParser extends SAXParser {
     ...
     * {@link #createDescMetaHandler(org.fourthline.cling.support.model.DescMeta, Handler)},
