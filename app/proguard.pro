...
-assumenosideeffects class android.util.Log {
 ...
 -keep class com.eagle.mibo.sdk.Mibo{public *;}
 -keep class com.eagle.mibo.sdk.MiboDeamonService{public *;}
 -keep class com.eagle.mibo.sdk.MiboProvider{public *;}
 -keep class com.eagle.mibo.sdk.MiboService{public *;}
 -keep class com.eagle.mibo.sdk.MiboJobService{public *;}