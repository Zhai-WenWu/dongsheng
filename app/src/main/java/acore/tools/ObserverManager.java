...
public class ObserverManager {
    ...
    public static final String NOTIFY_AUTO_LOGIN = "notify_auto_login";
    ...
    public static final String NOTIFY_LESSON_VIPBUTTON = "notify_lesson_vipbutton";
    public static final String NOTIFY_SAVE_VIDEO_DRAF = "save_video_draf";
