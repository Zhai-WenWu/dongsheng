...
public class LabelView extends TextView {
    ...
    public static final int LEFT_TOP = 30001;
    public static final int RIGHT_TOP = 30002;
    ...
    private void init() {
        ...
        setTextSize(Tools.getDimenSp(mCon, R.dimen.sp_12));
        setBackgroundColor(Color.BLUE);
    }

    public void setTargetView(View target, int distance, int gravity) {
    ...
    public void setTargetViewInBaseAdapter(View target, int targetWidth, int distance, int gravity) {
        if (!replaceLayout(target)) {
            return;
        }
        //measure(0, 0);
    ...
    private void calcOffset(int labelWidth, int distance, int gravity, int targetWidth, boolean isDP) {
