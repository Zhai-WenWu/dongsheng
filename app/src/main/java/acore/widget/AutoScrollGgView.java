 ...
 */
public class AutoScrollGgView extends LinearLayout {
	...
	private GgViewAdapter mAdapter;
	//显示的view
	...
	public AutoScrollGgView(Context context) {
		this(context, null);
	}

	public AutoScrollGgView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AutoScrollGgView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	/** 设置数据 */
	public void setAdapter(GgViewAdapter adapter) {
...
//			mSecondView.getLayoutParams().height = (int) mAdverHeight;
	...
	public static class GgViewAdapter {
		private List<Map<String, String>> mDatas;

		public GgViewAdapter(List<Map<String, String>> datas) {
			this.mDatas = datas;
		 ...
		 * @return
		 */
		public View getView(AutoScrollGgView parent) {
