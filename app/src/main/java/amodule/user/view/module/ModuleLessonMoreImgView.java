...
public class ModuleLessonMoreImgView extends ModuleBaseView{
    ...
    public ModuleLessonMoreImgView(Context context, AttributeSet attrs ) {
        super(context, attrs, R.layout.module_lesson_more_view);
    }

    public ModuleLessonMoreImgView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr, R.layout.module_lesson_more_view);
    }
...
//        setKeyContent(map,tv_content,"text2");
    ...
    private void setImageView() {
        ...
        LayoutParams viewIamgeParams = new LayoutParams(subjectImgWidth, subjectImgWidth * 2 / 3);

        LayoutParams _1PicLayoutParams = new LayoutParams(subjectImgWidth, subjectImgWidth * 2 / 3);
        LinearLayout.LayoutParams _1PicImageParams = new LinearLayout.LayoutParams(subjectImgWidth, subjectImgWidth * 2 / 3);

        LayoutParams _2PicLayoutParams = new LayoutParams(subjectImgWidth, (subjectImgWidth-Tools.getDimen(mContext,R.dimen.dp_4)) / 2);
        ...
        LayoutParams _3PicLayoutParams = new LayoutParams(subjectImgWidth, (subjectImgWidth-Tools.getDimen(mContext,R.dimen.dp_8)) / 3);
