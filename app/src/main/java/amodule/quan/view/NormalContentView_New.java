...
/**
 * Created by ：fei_teng on 2017/1/12 15:59.
 */
...
public class NormalContentView_New extends CircleItemBaseRelativeLayout  {
    ...
    private NormalContentView_New.OnAdCallback mOnAdCallback;
    private NormalContentView.OnAdHintListener mAdHintCallback;
    private NormalContentView_New.OnItemClickStatictis mOnItemClickStatictis;
    ...
    public NormalContentView_New(Activity context) {
        super(context);
     ...
     * @param Cid
     */
    public void initView(Map<String, String> maps, final String Cid,int position) {
        this.map = maps;
        //标准user
        ...
        normarlContentItemfootView.setFootViewCallback(new NormarlContentItemfootView.FootViewCallback() {
            ...
            public void onClickview(String site) {
                ...
                if (onClickData.size() >= 2) {
                    onClickData.add(1, "subjectInfo.app?code=" + map.get("code") + "&title=" + map.get("title") + "&isSafa=" + isSafa);
                } else {
                    onClickData.add("subjectInfo.app?code=" + map.get("code") + "&title=" + map.get("title") + "&isSafa=" + isSafa);
                }
            }
        });

        //设置userview 数据
        normalContentItemUserView.setViewData(map,position);
        ...
        normalContentItemUserView.setAdHintClickCallback(new NormalContentView.OnAdHintListener() {
            @Override
        ...
        //设置img view数据
        normarlContentItemImageVideoView.setViewData(map,position);
        ...
        //foot view
        normarlContentItemfootView.setViewData(map,position);
    ...
    public void setOnAdHintClick(View v,String eventId){
        if(mAdHintCallback != null)
            mAdHintCallback.onAdHintListener(v,eventId);
    }
    ...
    public void setOnAdCallback(NormalContentView_New.OnAdCallback onAdCallback) {
        this.mOnAdCallback = onAdCallback;
    }

    public void setAdHintCallback(NormalContentView.OnAdHintListener listener){
        mAdHintCallback = listener;
    }

    public void setmOnItemClickStatictis(NormalContentView_New.OnItemClickStatictis mOnItemClickStatictis) {
     ...
     * 删除回调
     */
    public void setDeleteSubjectCallBack(final NormalContentView_New.DeleteSubjectCallBack deleteSubjectCallBack, int position){
