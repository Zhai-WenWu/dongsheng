...
public class OfflineDishNew extends BaseActivity {
    ...
    private OnClickListener onLookLevel = new OnClickListener() {
        ...
        public void onClick(View v) {
            if (LoginManager.isLogin()) {
                ...
                AppCommon.openUrl(OfflineDishNew.this, url, true);
            } else {
                Tools.showToast(OfflineDishNew.this, "登录后即可查看您的等级");
                startActivity(new Intent(OfflineDishNew.this, LoginByAccout.class));
            }
        }
    };
    ...
    private void setListener() {
        rightBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                final DialogManager dialogManager = new DialogManager(OfflineDishNew.this);
                dialogManager.createDialog(new ViewManager(dialogManager)
                        .setView(new TitleView(OfflineDishNew.this).setText("清空离线菜谱"))
                        .setView(new MessageView(OfflineDishNew.this).setText("您确定要清空全部离线菜谱吗？"))
                        .setView(new HButtonView(OfflineDishNew.this)
                                ...
                                .setPositiveText("清空", new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        int x = Integer.parseInt(DataOperate.buyBurden(OfflineDishNew.this, "x"));
                                        //统计
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,int position, long arg3) {
                int offlineDishLimit = DataOperate.getDownDishLimit(OfflineDishNew.this);
                if(isAddHeadView)position --; //原因，添加了一个HeadView
                if(position > -1 && position < offlineDishLimit){
                    Intent intent = new Intent(OfflineDishNew.this, DetailDish.class);
        ...
        listView.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,int positon, long arg3) {
                ...
                final DialogManager dialogManager = new DialogManager(OfflineDishNew.this);
                dialogManager.createDialog(new ViewManager(dialogManager)
                        .setView(new TitleView(OfflineDishNew.this).setText("取消删除"))
                        .setView(new MessageView(OfflineDishNew.this).setText("确定要删除离线菜谱?"))
                        .setView(new HButtonView(OfflineDishNew.this)
                                .setNegativeText("取消", new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                ...
                                .setPositiveText("确定", new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        if(arrayList.size()==0)
                                            onBackPressed();
                                        Tools.showToast(OfflineDishNew.this,"删除成功");
                                        dialogManager.cancel();
                                    }
                                }))).show();
                return true;
    ...
    private void loadOffLine() {
        currentPage++;
        setOffLine(UtilString.getListMapByJson(DataOperate.loadPageBuyBurden(OfflineDishNew.this, currentPage)));
        isBlankSpace = false;
    }
