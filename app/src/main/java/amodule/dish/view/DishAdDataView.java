...
public class DishAdDataView extends DishBaseView {
    ...
    public DishAdDataView(Context context) {
        super(context, R.layout.view_dish_tips_ad_layout);
    }

    public DishAdDataView(Context context, AttributeSet attrs) {
        super(context, attrs, R.layout.view_dish_tips_ad_layout);
    }

    public DishAdDataView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr, R.layout.view_dish_tips_ad_layout);
    }
            ...
            public void callBack(Map<String, String> map) {
                ...
                if (adDataMap.containsKey("type")) {
                    switch (adDataMap.get("type")) {
                        ...
                        case AdPlayIdConfig.ADTYPE_INMOBI:
    ...
    private void setBigPicADData(final Map<String, String> map, ViewGroup parentView) {
        ...
        imgWidth = ToolsDevice.getWindowPx(getContext()).widthPixels - Tools.getDimen(getContext(), R.dimen.dp_60);
    ...
    private void setAdHintClick(int id) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                AppCommon.setAdHintClick((Activity) DishAdDataView.this.getContext(), v, xhAllAdControl, 0, "");
            }
        });
    }
    ...
    private void exposureAdData() {
        DishAdDataView.this.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                xhAllAdControl.onAdClick(DishAdDataView.this, 0, "");
            }
        });
    }
    ...
    private void addViewToPraent(int showId, ViewGroup parentView) {
        ...
        Log.i("tzy", "addView");
        parentView.addView(DishAdDataView.this);
    }
