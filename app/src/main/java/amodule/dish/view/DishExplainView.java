...
public class DishExplainView extends ItemBaseView {
    ...
    public void setData(final Map<String,String> maps, Activity activitys){
        ...
        //举报
        findViewById(R.id.explain_report).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //评论
        findViewById(R.id.subjectfloorNum_tv).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        //晒菜
        findViewById(R.id.gouploadsubject_tv).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
