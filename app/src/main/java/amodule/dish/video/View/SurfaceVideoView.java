...
//		Logger.e("[SurfaceVideoView]start...1");
		Log.i("zhangyujian",":"+mMediaPlayer+":::"+mCurrentState+":::"+isPlaying());
...
//				Logger.e(e);
	...
	public void openVideo(Uri uri) {
		Log.i("zhangyujian",":uri:::"+uri+"::mSurfaceHolder::"+mSurfaceHolder+"::;"+getContext());
...
//			Logger.e("[VideoView]Error:" + framework_err + "," + impl_err);
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		Log.i("zhangyujian",":mSurfaceHolder:111::"+mSurfaceHolder+":::"+holder);
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
		mSurfaceHolder = holder;
		Log.i("zhangyujian",":mSurfaceHolder:222::"+mSurfaceHolder+":::"+holder);
	}

	@Override
	public void surfaceDestroyed(SurfaceHolder holder) {
		mSurfaceHolder = null;
		Log.i("zhangyujian",":mSurfaceHolder:333::"+mSurfaceHolder+":::"+holder);
		release();
	}
