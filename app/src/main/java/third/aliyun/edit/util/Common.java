...
//        public static final String BASE_URL = "http://m.api.inner.alibaba.net"; //内网地址（开发环境）
    ...
    public final static String QU_NAME = "aliyun";
    ...
    public final static String QU_TAxIL_IMG = "tail_img/qupai-logo.png";
...
//        /storage/emulated/0/Android/data/com.quze.lbsvideo/cache/AliyunEditorDemo
...
//        SD_DIR = "/storage/emulated/0/";
        ...
        Log.i("xianghaTag","SD_DIR:::"+SD_DIR+":::QU_DIR:::"+QU_DIR);
        File longDir= new File(FileManager.getSDLongDir() + Common.QU_NAME+ File.separator);
        longDir.mkdirs();
        mView = view;
...
//        }
    ...
    public static void unZip() {
        Log.i("xianghaTag","Common.SD_DIR + QU_NAME:::"+(Common.SD_DIR + QU_NAME));
