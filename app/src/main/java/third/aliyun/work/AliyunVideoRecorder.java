...
//        intent.putExtra(AliyunConfig.KEY_FROM, "com.duanqu.qupai.action.recorder.setting");
    ...
    private void getStyleParam() {
        ...
        mLightDisableRes = a.getResourceId(4, R.drawable.aliyun_svideo_icon_light_dis);
    ...
    private void reSizePreview() {
        ...
        switch (mRatioMode) {
            ...
            case AliyunSnapVideoParam.RATIO_MODE_9_16:
                ...
                mRecordTimelineView.setColor(mTintColor, mTimelineDelBgColor, R.color.qupai_black_opacity_70pct, R.color.aliyun_transparent);
                break;
        }
