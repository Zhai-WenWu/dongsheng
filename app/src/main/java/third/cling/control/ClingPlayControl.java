...
import third.cling.entity.ClingPositionResponse;
import third.cling.entity.ClingResponse;
import third.cling.entity.ClingVolumeResponse;
...
public class ClingPlayControl implements IPlayControl {
    ...
    public void seek(int pos, final ControlCallback callback) {
       ...
       //YLKLog.i(TAG, "seek->pos: " + pos + ", time: " + time);
    ...
    private String pushMediaToRender(String url, String id, String name, String duration) {
       ...
       //YLKLog.i(TAG, "metadata: " + metadata);
        return metadata;
    }
    ...
    private String createItemMetadata(DIDLObject item) {
        ...
        if (res != null) {
           ...
           //YLKLog.i(TAG, "protocolinfo: " + protocolinfo);
