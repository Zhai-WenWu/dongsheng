...
public class AdControlNormalDish extends AdControlParent implements ActivityMethodManager.IAutoRefresh{
    ...
    public AdControlNormalDish(String statisticKey,String[] adPlayIds){
        ...
        this.adPlayIds=adPlayIds;
        this.statisticKey=statisticKey;
        AdOptionHomeDish downLoadAdControl0 = new AdOptionHomeDish(adPlayIds);
        ...
        AdOptionHomeDish adControlParent = new AdOptionHomeDish(adPlayIds);
    ...
    public void refreshData() {
        ...
        AdOptionHomeDish downLoadAdControl1 = new AdOptionHomeDish(adPlayIds);
