...
public class MzGrant_New {
    ...
    public static void loginFlyme(final BaseActivity mAct){
        ...
        mAuthenticator.requestImplictAuth(mAct,MzGrant.SCOPE, new ImplictCallback() {
            ...
            @Override
            public void onGetToken(final OAuthToken token){
    ...
    private static void getUserInfo(final BaseActivity mAct, final String token){
