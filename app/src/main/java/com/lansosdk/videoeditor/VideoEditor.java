...
//					cmdList.add("copy");
	...
	public int executeRotate90ClockwiseX264( String srcPath,String decoder,int bitrate,String dstPath)
	{
		//ffmpeg -i INPUT -vf transpose=1 -c:a copy output.mp4  //<----顺时针旋转视频90度
		if(fileExist(srcPath)){
...
//	    		bitrate=2500*1000; //2.5M
	 ...
	 * @param str
     */
		public int  executeShort(String str){
			String[] newStr=str.split(" ");
			return executeVideoEditor(newStr);
		}
