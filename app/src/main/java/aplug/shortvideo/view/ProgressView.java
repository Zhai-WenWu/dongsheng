...
public class ProgressView extends View {
	...
	private boolean canAllowOverflow = false;
...
//				} else {
//					//画进度
//					if (hasOutDuration && canAllowOverflow) {
//						//超时拍摄
//						//前段
...
//	}
	...
	public boolean isCanAllowOverflow() {
		return canAllowOverflow;
	}

	public void setCanAllowOverflow(boolean canAllowOverflow) {
