...
import static aplug.recordervideo.tools.ToolsCammer.isDevice;

/**
 * 视频录制抽象类
 */
public abstract class MediaRecorderBaseShort implements Callback, PreviewCallback {
	/**
	 *小视频高度
	 */
	...
	/** 最小帧率 */
	public static final int MIN_FRAME_RATE = 8;
